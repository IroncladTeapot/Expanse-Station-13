...
/obj/item/weapon/rig/reaver
	name = "UNMC hardsuit control module"
	desc = "A power armour used by United Nations Marines. It's Sleek Black. Armoured and space ready."
	suit_type = "Asset Protection command"
	icon_state = "reaver_rig"

	chest_type = /obj/item/clothing/suit/space/rig/reaver
	helm_type = /obj/item/clothing/head/helmet/space/rig/reaver
	boot_type = /obj/item/clothing/shoes/magboots/rig/reaver
	glove_type = /obj/item/clothing/gloves/rig/reaver

	req_access = list(access_cent_specops)

	armor = list(melee = 60, bullet = 60, laser = 20,energy = 15, bomb = 30, bio = 100, rad = 100)
...
/obj/item/clothing/head/helmet/space/rig/reaver
	light_overlay = "helmet_light_dual"
	camera = /obj/machinery/camera/network/ert
	species_restricted = list(SPECIES_HUMAN,SPECIES_SKRELL,SPECIES_UNATHI)

/obj/item/clothing/suit/space/rig/reaver
	species_restricted = list(SPECIES_HUMAN,SPECIES_SKRELL,SPECIES_UNATHI)

/obj/item/clothing/shoes/magboots/rig/reaver
	species_restricted = list(SPECIES_HUMAN,SPECIES_SKRELL,SPECIES_UNATHI)

/obj/item/clothing/gloves/rig/reaver
	species_restricted = list(SPECIES_HUMAN,SPECIES_SKRELL,SPECIES_UNATHI)
