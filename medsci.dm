...
/obj/item/clothing/under/rank/unnscrubs
	desc = "A loose-fitting garment designed to provide minor protection against biohazards. It has UNN stamped above it's pocket in white."
	name = "unn scrubs"
	icon_state = "unn_scrubs"
	item_state = "unn_scrubs"
